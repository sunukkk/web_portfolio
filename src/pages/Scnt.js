...
import scntValHtml from '../asset/validator/scnt/HTML.png';
import scntValCss from '../asset/validator/scnt/CSS.png';
import scntValLighthouse from '../asset/validator/scnt/LIGHTHOUSE.png';
        ...
        <div className='contents'>
          ...
          <div className="samplebox" ref={sampleBoxRef}>
            <div className="sample_pc" ref={samplePcRef}>
              <video src={process.env.PUBLIC_URL + '/videos/Scnt_PC.mp4'} autoPlay loop muted width={'100%'} height={'100%'} preload='auto'></video>
            </div>
            <div className="sample_tablet" ref={sampleTabletRef}>
              <video src={process.env.PUBLIC_URL + '/videos/Scnt_Tablet.mp4'} autoPlay loop muted width={'100%'} height={'100%'} preload='auto'></video>
            </div>
            <div className="sample_mobile" ref={sampleMobileRef}>
              
              <video src={process.env.PUBLIC_URL + '/videos/Scnt_Mobile.mp4'} autoPlay loop muted width={'100%'} height={'100%'} preload='auto'></video>
            </div>
          </div>
          ...
          <div className="descbox">
            <div className="date_skills_link" >
              ...
              <div className="linkbox" ref={linkBoxRef}>
                <h3>Link</h3>
                <a href="https://github.com/sunukkk/portfolio_samsung_cnt_clone" target="_blank" rel="noopener noreferrer">GITHUB</a>
                <a href="https://sunukkk.github.io/portfolio_samsung_cnt_clone/" target="_blank" rel="noopener noreferrer">SITE</a>
