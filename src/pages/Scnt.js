        ...
        <div className='contents'>
          ...
          <div className="samplebox" ref={sampleBoxRef}>
            <div className="sample_pc" ref={samplePcRef}>
              <video src={process.env.PUBLIC_URL + '/videos/Scnt_PC.mp4'} autoPlay loop muted width={'100%'} height={'100%'}></video>
            </div>
            <div className="sample_tablet" ref={sampleTabletRef}>
              <video src={process.env.PUBLIC_URL + '/videos/Scnt_Tablet.mp4'} autoPlay loop muted width={'100%'} height={'100%'}></video>
            </div>
            <div className="sample_mobile" ref={sampleMobileRef}>
              
              <video src={process.env.PUBLIC_URL + '/videos/Scnt_Mobile.mp4'} autoPlay loop muted width={'100%'} height={'100%'}></video>
            </div>
          </div>
